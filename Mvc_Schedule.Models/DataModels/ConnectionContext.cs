...
namespace Mvc_Schedule.Models.DataModels
{
	public sealed class ConnectionContext : DbContext
	{
		...
		//public DbSet<Subject> Subjects { get; set; } // ver 2.1 Необоснованная трата ресурсов (нормализация не столь важна)
	...
	//        else
	//        {
	//            throw new ApplicationException("Увы, у нас ошибка MSSQL::Context->База Данных отсутсвует " + context.Database.Connection.ConnectionString);
	//        }
	//    }
